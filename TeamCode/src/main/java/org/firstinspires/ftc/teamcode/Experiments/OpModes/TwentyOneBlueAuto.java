...
@Config
public class TwentyOneBlueAuto extends OpMode {
    ...
    public static double first_shoot_wait_time = 1400;
    public static double shoot_wait_time = 600;
    public static double gate_wait_time = 4000;
    int loops = 0;
    ...
    public void loop() {
        ...
        switch (state) {
            ...
            case intakeGate:
                ...
                if (timer.milliseconds() > gate_wait_time || intake.intakeCurrentThreshold(6.7) == 1) {
                    timer.reset();
                    state = State.driveToShootPos;
                }
                break;
